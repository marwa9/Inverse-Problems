function [x_all,x,iter,cost_function]=min_f0(f0,grad_f0,x_init,x0,alpha,epsilon)
...
while diff
    ...
    x1 = x(1) - alpha*grad_f0_val(1);
    x2 = x(2) - alpha*grad_f0_val(2);
    x=[x1;x2];
    x_all = [x_all;[x1 x2]];
    f0_k = double(f0(x(1),x(2)));
